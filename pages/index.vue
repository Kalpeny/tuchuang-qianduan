  ...
  <div class="home">
    <div class="hero">
      <div class="hero-content">
        <h1 class="gradient-title">✨欢迎使用老王图床</h1>
        <p class="subtitle">基于Cloudflare的个人图床新选择</p>
        <div class="action-buttons">
          <NuxtLink to="https://tuchuang.6512624.xyz" target="_blank" class="btn primary">即刻开始</NuxtLink>
          <a href="https://tuchuang.6512624.xyz" target="_blank" class="btn secondary">
